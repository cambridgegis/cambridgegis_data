...
|----|------------|-----------|
|TYPE|type: String<br/>width: 50<br/>precision: 0|Type of water body (pond, stream, wetland)|
|NAME|type: String<br/>width: 50<br/>precision: 0|Name of water body (unpopulated)|
