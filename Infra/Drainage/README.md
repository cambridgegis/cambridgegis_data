...
|----|------------|-----------|
|TYPE|type: String<br/>width: 50<br/>precision: 0|type of drainage (ditch, sewer or drain crossing, ect)|
|NAME|type: String<br/>width: 50<br/>precision: 0|No names are populated|
