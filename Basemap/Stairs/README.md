...
|----|------------|-----------|
|TYPE|type: String<br/>width: 50<br/>precision: 0|All types are flight of stairs (plaza stairs in layer plazas)|
|TOP_GL|type: Double<br/>width: 8<br/>precision: 38|Elevation of highest point above ground level (NAVD88)|
|ELEV_SL|type: Double<br/>width: 8<br/>precision: 38|Elevation of stairs above sea level (NAVD88)|
...
|STAIR_TYPE|type: String<br/>width: 10<br/>precision: 0|Building or walkway|
|ELEV_GL|type: Double<br/>width: 8<br/>precision: 38|Elevation of roofline edge above ground level (NAVD88)|
